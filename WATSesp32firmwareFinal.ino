 ...
 * Description: Send Request car for PIDs option, send to phione via BLE, and waith for any requst from phone
 * and send request to car, get responce and send back to phone
...
// Polling interval (ms)
#define POLLING_RATE_MS 150 // 1000
...
void setup() {
  ...
  // Set up a callback to handle writing data to the characteristic
...
void handleReceivedMessage(twai_message_t &message) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x14) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x15) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x16) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x17) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x18) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x19) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x1A) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x1B) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x24) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x25) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x26) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x27) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x28) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x29) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x2A) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x2B) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x34) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x35) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x36) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x47) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x38) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x39) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x3A) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x3B) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x4F) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x55) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x56) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x57) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x58) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x64) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x66) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x67) {
  ...
  if (message.identifier == 0x7E8 && message.data[2] == 0x68) {
...
void loop() {
  ...
  // if get any data via ble, analyze package and prepare to send request to car
  if (packetIndex > 0 && (millis() - lastRequestTime > 150) || GGreset == 1) {
    Serial.println("Start from here");
    lastRequestTime = millis();
 
    // check nuber of packega and reset count to 0 for start over
  ...
  if (alerts_triggered & TWAI_ALERT_RX_DATA) {
    ...
    if (isRunning == true && RaceFlag == 1) {
      ...
      Serial.println("Hex: " + SaveDataTypeHex);
      //Serial.println("Data: " + SaveDataValue);
      Serial.println("Packgae to send: " + SendDataBLE);
      // Check if hex is not 00(fix bag for fisrst sendind data)
      if(SaveDataTypeHex != "00")
      {
